                ...
                <div class="row">
                  ...
                  <div class="col-lg-3 col-md-4 col-12 border-end  d-md-block">
                    <div class="pt-10 pe-lg-10">
                      ...
                      <ul class=" mySidenav sidenav nav flex-column nav-pills nav-pills-dark">
                         <!-- nav item -->
                         <li class="nav-item" id="close">
                          <a class="nav-link active" href="{{ airoute('aimeos_shop_account')}}"><i class="fa fa-comments me-2" aria-hidden="true"></i>Reviews</a>
                        </li>
                        <!-- nav item -->
                        <li class="nav-item">
                        ...
                        <!-- nav item -->
                        <li class="nav-item">
                            <a class="nav-link " aria-current="page" href="{{ airoute( 'aimeos_shop_kyc_cliqnshop' ) }}">
                        ...
                        <!-- nav item -->
                        <li class="nav-item">
                          <a class="nav-link" href="{{ airoute('aimeos_shop_subscription')}}"><i class="fa fa-rocket me-2" aria-hidden="true"></i>Subscription</a>
                        </li>
                        <!-- nav item -->
                        <li class="nav-item">
                          <a class="nav-link" href="{{ airoute('aimeos_shop_account_favorite')}}"><i class="fa fa-heart me-2" aria-hidden="true"></i> Favorite Products</a>
                        </li>
                        <!-- nav item -->
                        <li class="nav-item">
                          <a class="nav-link" href="{{ airoute('aimeos_shop_account_watch')}}"><i class="fa fa-eye me-2" aria-hidden="true"></i>Watched Products</a>
                        </li>
                        <!-- nav item -->
                        <li class="nav-item">
                          <hr>
                        ...
                        <!-- nav item -->
                        <li class="nav-item">
                            <form class="feather-icon icon-bell me-2 nav-link" id="logout" action="{{ airoute( 'logout' ) }}" method="POST">{{ csrf_field() }}<button class="nav-link p-0"><span><i class="fa fa-stop me-2" aria-hidden="true"></i>{{ __( 'Logout' ) }}</span></button></form>
                            </li>
                      </ul>
                    </div>
                  </div>
