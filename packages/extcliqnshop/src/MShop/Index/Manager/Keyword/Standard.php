...
class Standard
	...
	implements \Aimeos\MShop\Index\Manager\Keyword\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	private $searchConfig = array(
		'keyword.id' => array(
			'code' => 'keyword.id',
			'internalcode' => 'mindkey."keyid"',
			'internaldeps'=>array( 'LEFT JOIN "mshop_index_keyword" AS mindkey ON mindkey."prodid" = mpro."id"' ),
	...
	public function clear( iterable $siteids ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->clearBase( $siteids, 'mshop/index/manager/keyword/delete' );
	}
	...
	public function cleanup( string $timestamp ) : \Aimeos\MShop\Index\Manager\Iface
	{
		 ...
		 */
		return $this->cleanupBase( $timestamp, 'mshop/index/manager/keyword/cleanup' );
	}
	...
	public function delete( $items ) : \Aimeos\MShop\Common\Manager\Iface
	{
		 ...
		 * @see mshop/index/manager/catalog/search/ansi
		 */
		return $this->deleteItemsBase( $items, 'mshop/index/manager/keyword/delete' );
	}
	...
	{
		$path = 'mshop/index/manager/keyword/submanagers';

		return $this->getResourceTypeBase( 'index/keyword', $path, [], $withsub );
	}
	...
	public function getSearchAttributes( bool $withsub = true ) : array
	{
		...
		/** mshop/index/manager/keyword/submanagers
	...
	public function getSubManager( string $manager, string $name = null ) : \Aimeos\MShop\Common\Manager\Iface
	{
		...
		return $this->getSubManagerBase( 'index', 'keyword/' . $manager, $name );
	}
	...
	public function optimize() : \Aimeos\MShop\Index\Manager\Iface
	{
		 ...
		 */
		return $this->optimizeBase( 'mshop/index/manager/keyword/optimize' );
	}
	...
	public function rebuild( iterable $items = [] ) : \Aimeos\MShop\Index\Manager\Iface
	{
		...
		$conn = $context->db( $this->getResourceName() );
			 ...
			 * @see mshop/index/manager/catalog/count/ansi
			 */
            $stmt = $this->getCachedStatement( $conn, 'mshop/index/manager/keyword/insert' );
            
			foreach( $items as $id => $item )
			{
                foreach( $item->getListItems( 'keyword' ) as $listItem )
				{
	...
	public function search( \Aimeos\Base\Criteria\Iface $search, array $ref = [], int &$total = null ) : \Aimeos\Map
	{
		 ...
		 * @see mshop/index/manager/catalog/aggregate/ansi
		 */
		$cfgPathSearch = 'mshop/index/manager/keyword/search';
		 ...
		 * @see mshop/index/manager/catalog/aggregate/ansi
		 */
		$cfgPathCount = 'mshop/index/manager/keyword/count';
	...
	protected function getSubManagers() : array
	{
		if( $this->subManagers === null )
		{
			 ...
			 */
			foreach( $config->get( 'mshop/index/manager/keyword/submanagers', [] ) as $domain )
			{
				$name = $config->get( 'mshop/index/manager/keyword/' . $domain . '/name' );
