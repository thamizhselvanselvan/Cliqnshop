	...
	implements \Aimeos\Client\Html\Common\Client\Factory\Iface
{
    ...
    {
        $content = $this->replaceSection( $content, $this->breadcrumb(), 'catalog.detail.breadcrumb' );
    ...
    public function breadcrumb() : string
    {
        ...
        $context = $this->context();
        $config = $context->config();
        $template = $config->get( 'client/html/catalog/detail/template-breadcrumb', 'catalog/detail/breadcrumb' );
        return $view->render( $template );		
    }
