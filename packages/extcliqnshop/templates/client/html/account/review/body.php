    ...
    <div class="container-xxl">
        ...
        <form method="POST" action="<?= $enc->attr( $this->link( 'client/html/account/review/url' ) ) ?>">
                    ...
                    <div class="col-md-9 row">
                        <div class="col-md-12">
                            <h3 class="review-name">
                                <?= $enc->html( $productItem->getName() ) ?>
                            </h3>

                            <div class="review-rating row">
                                <div class="rating-line rate-area col-md-3">
                                    <h4>
                                        <?= $enc->html( $this->translate( 'client', 'Your rating' ) ) ?>
                                    </h4>
                                    <input id="rating-<?= $enc->attr( $prodId ) ?>-5" class="rating rating-5" required
                                        type="radio" value="5"
                                        name="<?= $this->formparam( ['review', $prodId, 'review.rating'] ) ?>"
                                ...
                                <div class="col-md-9">
                                    <h4>
                                        <?= $enc->html( $this->translate( 'client', 'Your review' ) ) ?>
                                    </h4>
            ...
            <button class="btn btn-primary">
                <?= $enc->html( $this->translate( 'client', 'Submit' ) ) ?>
            </button>
