    ...
    <div class="aimeos">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:550px;"><img height="auto"
                                                                src="<?= $this->get( 'logo' ) ?>"
                                                                style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:200px;padding-bottom: 40px;"
                                                                width="550"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
        ...
        <div style="Margin:0px auto;max-width:600px;>
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;text-align:center;vertical-align:top;display: grid;grid-template-columns: 1fr 1fr;grid-gap: 10px;">
                            <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" style="vertical-align:top;width:600px;" ><![endif]-->
                            <div class="mj-column-per-100 outlook-group-fix"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="left" class="email-common-salutation"
                                            style="font-size:0px;padding:0 0 10px 0;word-break:break-word;">
                                            <div
                                                style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:0.8rem;line-height:1;text-align:left;color:#444;">
        ...
        <div class="common-summary common-summary-address" style="Margin:0px auto;max-width:600px;">
            <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                <tbody>
                    <tr>
                        <td style="display: flex;column-gap: 10px;margin-bottom: 10px;">
                            ...
                            <div class="mj-column-per-50 outlook-group-fix item payment"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:inherit;word-break:break-word;">
                                            <div style="border: 1px solid #e3e9ed;border-radius: 5px;padding: 10px;">
                                                <h3 style="padding: 0 0 8px 0;font-size:0.8rem;color: #212427;margin: 0;font-weight: 600;border: none;">
                                                ...
                                                <div class="content" style="font-size: 0.8rem;line-height: 20px;color: #444;padding: 0;margin: 0;">
						...
						$addr->getVatID()
                            ...
                            <div class="mj-column-per-50 outlook-group-fix item delivery"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:inherit;word-break:break-word;">
                                            <div style="border: 1px solid #e3e9ed;border-radius: 5px;padding: 10px;">
                                                ...
                                                <div class="content" style="font-size: 0.8rem;line-height: 20px;color: #444;padding: 0;margin: 0;font-weight: 400;">
                                                    <?= preg_replace( ["/\n+/m", '/ +/'], ['<br/>', ' '], trim( $enc->html( sprintf(
							/// Address format with company (%1$s), salutation (%2$s), title (%3$s), first name (%4$s), last name (%5$s),
							/// address part one (%6$s, e.g street), address part two (%7$s, e.g house number), address part three (%8$s, e.g additional information),
							/// postal/zip code (%9$s), city (%10$s), state (%11$s), country (%12$s), language (%13$s),
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:inherit;word-break:break-word;">
                                            <div style="border: 1px solid #e3e9ed;border-radius: 5px;padding: 10px;">
                                                ...
                                                <div class="content" style="font-size: 0.8rem;line-height: 20px;color: #444;padding: 0;margin: 0;">
                                                    <h4 style="font-weight: 400;font-size: 0.8rem;line-height: 20px;color: #444;padding: 0;margin: 0;">
                ...
                <tbody>
                    <tr>
                        <td style="display: flex;column-gap: 10px;margin-bottom: 10px;">
                            ...
                            <div class="mj-column-per-33 outlook-group-fix item coupon"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                            ...
                            <div class="mj-column-per-33 outlook-group-fix item customerref"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                            ...
                            <div class="mj-column-per-33 outlook-group-fix item comment"
                                style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                        ...
                        <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                            ...
                            <div class="mj-column-per-100 outlook-group-fix"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="vertical-align:top;" width="100%">
                                    <tr>
                                        <td align="left" class="basket p-0"
                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table cellpadding="0" cellspacing="0" width="100%" border="0"
                                                ...
                                                <tr class="header" style="background-color: #f6f6f6;border:none;">
                                                    <th class="status"></th>
                                                    <th class="label">
                                                ...
                                                <tr class="body product">
                                                    ...
                                                    <td class="label">
                                                        ...
                                                        <span class="product-name" style="font-size: 0.8rem;color:#212427;">
                                                            <?= $enc->html( $product->getName(), $enc::TRUST ) ?>
                                                        </span>
                                                        <p class="code" style="font-size: 0.8rem;color:#444; margin: 0;"><span class="name">
								...
								&& ( $attribute = $product->getAttributeItem( 'download', 'hidden' ) ) ) : ?>
                                                ...
                                                <tr class="footer total" style="background-color:#f6f6f6;border:none">
                                                    <td class="status"></td>
                                                    <td class="label">
