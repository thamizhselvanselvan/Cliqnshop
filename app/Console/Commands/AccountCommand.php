...
class AccountCommand extends Command
{
	...
	protected $signature = 'aimeos:account
		...
		{--order : If account should have site administrator privileges}
		{--catalog : If account should have site administrator privileges}
		...
		\Aimeos\MShop\Customer\Item\Iface $user ) : \Aimeos\MShop\Customer\Item\Iface
	{
		...
		if( $this->option( 'order' ) ) {
			$user = $this->addGroup( $context, $user, 'order' );
		}

		if( $this->option( 'catalog' ) ) {
			$user = $this->addGroup( $context, $user, 'catalog' );
		}
