...
<style>
    ...
    We verify the contents, inspect the package for damage, and manifest your order.</p>
                ...
                <div class="p-4 grid-algin2">
                    ...
                    <p>When your <span class="fw-bolder">cliqnshop</span> package reaches United Arab Emirates, there will be no importation or duty formalities to worry about. The final quality check, inspection, and distribution of all items takes place in our <span class="fw-bolder">cliqnshop</span> warehouse in United Arab Emirates.</p>
                </div>
                <div class="border-left">
                    <h1 class="works-heading">4</h1>
                    <p >Using one of our logistics partners, your order is dispatched from our United Arab Emirates warehouse.</p>
                </div>
                <div class=" p-4">
