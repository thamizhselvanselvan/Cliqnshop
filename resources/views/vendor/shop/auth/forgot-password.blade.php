          ...
          <form method="POST" action="{{ airoute('password.email') }}"">
            ...
            <div class="row g-3">
              ...
              <div class="col-12 d-grid"> 
                <button type="submit" class="btn btn-primary rounded-1">{{ __('Email Password Reset Link') }}</button>
              </div>
